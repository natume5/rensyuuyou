...
子テンプレートで上書きさせる箇所は
{% block ブロック名 %}と{% endblock %}を記述します。
上のコードのヘッダー、フッター部分のように、
ブロック内部に何かを記述することもできます。
...
に囲まれたブロック内に内容を記述します。
また、親テンプレートのブロック内の内容を出力したい場合は
８行目のように{{ super() }}を記述します。


出力結果

それでは出力してみましょう。
テンプレートファイルに子テンプレートを指定します。
親テンプレートの指定は必要ありません。
"""
